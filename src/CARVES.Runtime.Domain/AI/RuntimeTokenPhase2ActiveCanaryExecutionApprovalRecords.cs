...
public sealed record RuntimeTokenPhase2ActiveCanaryExecutionApprovalResult
{
    public string SchemaVersion { get; init; } = "runtime-token-phase2-active-canary-execution-approval.v1";
    ...
    public string ApprovalReviewMarkdownArtifactPath { get; init; } = string.Empty;

    public string ApprovalReviewJsonArtifactPath { get; init; } = string.Empty;
    ...
    public string ReviewVerdict { get; init; } = "blocked_for_active_canary_execution";

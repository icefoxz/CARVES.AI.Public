...
public sealed record RuntimeTokenPhase2PostCanaryGateResult
{
    public string SchemaVersion { get; init; } = "runtime-token-phase2-post-canary-gate.v1";
    ...
    public string GateVerdict { get; init; } = "blocked_pending_post_canary_evidence";

    public string CanaryResultReviewVerdict { get; init; } = "inconclusive";

    public bool MainPathReplacementReviewAllowed { get; init; }

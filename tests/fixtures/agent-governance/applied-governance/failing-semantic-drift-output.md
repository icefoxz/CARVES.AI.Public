...
| docs/runtime/runtime-applied-governance-operator-override-phase-7-5.md | OutsideAiLifecycle | requires_governed_card_first | host-routed-card-first | Operator-directed local patch was incorrectly routed as normal governed-card work. |
